      ...
      <div className="wrapper">
        ...
        <div className="cprof-outer">
          <div className="cprof-container1">
            ...
            <div className="cprof-description">
              <p>
                ...
                started with an intake of 180 students in 1984 has evolved as a
            ...
            <MyModal
              ...
              <h5>
                ...
                Tamil Nadu. Dr. G. Viswanathan life is a source of inspiration
                ...
                childhood. His early education was confined to his small village
                where he studied in Tamil - his mother tongue. His
                pre-university education at Voorhees College, Vellore initiated
                him to the world outside. From there he moved on to obtain his
                Bachelors and Masters Degrees in Economics from the prestigious
                ...
                indelible impact on the society. The engineering college that
                started with an intake of 180 students in 1984 has evolved as a
                university with four campuses. Over 25,000 students are enrolled
                in 51 undergraduate and 33 Postgraduate, 11 Integrated, 2
                Research programmes and 2 M.Tech Industrial Programmes with
                nearly 16,000 residing on the campus. It attracts students and
                professors from different parts of the world. It houses more
                than 1000 international students on campus. For the past two
                years, VIT University has been ranked #1 private engineering
                institution in India. ISO Certification from Holland,
                International accreditation from the United Kingdom and USA, and
                ...
                saplings has begun to yield fruit. Dr. G. Viswanathan
          ...
          <div className="cprof-container1">
            ...
            <div className="cprof-description">
              <p>
                Dr. Izuru Umehara is a renowned Professor of Applied Physics at
                Yokohama National University, Japan, currently serving as the
                President of YNU. With over 130 research articles published in
                international scientific journals and over 4,500 citations, he
                has made significant contributions in the field of theoretical
                and...
              </p>
            ...
            <MyModal
              ...
              keyboard={true}>
              <h5>
                <b>Dr. Izuru Umehara</b>
                <br />
                President, Yokohama National University
                <br /> <br />
                <b> Academic Background</b> March 1992 Doctor of Engineering,
                University of Tsukuba March 1989 Master of Science, University
                of Toyama March 1987 Graduate from School of Science, University
                of Toyama
                <br />
                <br />
                <b>Education & Work Experience</b> April 2021 President,
                Yokohama National University April 2020 Executive Director for
                Research, Finance, Information and Evaluation (Vice-President),
                Yokohama National University April 2019 Executive Director for
                Research and Evaluation (Vice-President), Yokohama National
                University October 2009 Professor, Faculty of Engineering,
                Yokohama National University July 2000 Associate Professor,
                College of Engineering, Yokohama National University April 1994
                Research Associate, College of Engineering, Yokohama National
                University April 1992 Academic Affairs Staff, College of
                Engineering, Yokohama National University
                <br />
                <br />
                <b>Research Fields</b> Solid State Physics, Single Crystal, Low
                Temperature, High Pressure, Specific Heat, Strongly Correlated
                Electron System
                <br />
                <br />
                <b>Mission Statement</b> UMEHARA Izuru was elected 16th
                president of Yokohama National University (YNU) in April 2021.
                At the beginning of his presidential position, he made clear
                about the four strategies and roles that YNU should take to
                become a world-class research oriented university: (1) Research
                Strategy (fostering practical academic research which aims to
                become a world-class research university); (2) Educational
                Strategy (transmission of high-standard education resulting from
                research enhancement); (3) Industry-academia-government
                Collaboration and International-regional Cooperation Strategy
                (promoting regional cooperation from Yokohama and Kanagawa to
                the world); and (4) University Management Strategy
          ...
          <div className="cprof-container1">
            ...
            <div className="cprof-description">
              <p>
                ...
                mechanics and diagnostics of building structures, as....
              </p>
            ...
            <MyModal
              ...
              <h5>
                ...
                teacher and academic leader popular among students.
                <br />
                <br />
                ...
                Sciences. Prof. Wilde is also the vice-chairman of the
                Conference of Rectors of Polish Technical Universities (Polish
                acronym: KRPUT, since 2020), the chairman of the Council of
                Rectors of the Pomeranian Voivodeship (since 2020), and in 2023
                he was appointed co-chairman of the Board of Directors of the
                ENHANCE Alliance, which consists of 10 leading European
                technical universities. He is also one of the advisers to the
                Minister of Science and Higher Education within the scope of
                infrastructural investments in Polish science.
                <br />
                <br />
                Prof. Krzysztof Wilde was one of the initiators of the
                Fahrenheit Union of Universities in Gdańsk (2019), which
                includes the Medical University of Gdańsk, Gdańsk University of
                Technology and the University of Gdańsk. Integration of the
                region's three best universities, which are to become a
                federation in the future, is to strengthen the position of
                Gdańsk as a strong academic center in this part of Europe. The
                Rector was the first chairman of Fahrenheit Union and
                established the main directions of further development of this
                initiative.
                <br />
                <br />
                ...
                <br />
                <br />
                <b>Gdańsk University of Technology</b>
                <br />
                <br /> Gdańsk University of Technology is one of the best
                universities in Poland, for several years it has maintained the
                third place in the most important classification of technical
                universities in the country, developed by "Perspektywy"
                educational foundation, and the sixth place in the
                classification of universities, regardless of the profile of
                activity.
                <br />
                <br />
                In 2019, in the ministerial program "Excellence Initiative -
                Research University", Gdańsk Tech was ranked second among the
                top 10 academic centers in Poland - the highest among
              </h5>
            </MyModal>
          </div>
        </div>
        ...
        <div className="cprof-outer">
          <div className="cprof-container1">
            ...
            <div className="cprof-description">
              <p>
                Mr. Sankar Viswanathan has held honorable positions as the
                Chairman, and Vice-Chairman of Vellore Engineering College,
                Vellore before taking over charge as the Pro-Chancellor
                (Academic) at VIT. He has also served as the Secretary of the
                North Arcot Educational & Charitable Trust of Vellore. He has
                always been a very...
              </p>
            ...
            <MyModal
              ...
              keyboard={true}>
              <h5>
                <b>Mr. Sankar Viswanathan</b> Vice - President
                <br />
                <br />
                Mr. Sankar Viswanathan, Vice President was born on 13th April
                1966. He completed his Advanced Diploma in Engineering
                Technology, at Chisholm Institute, Melbourne, Australia.He has
                held honoured positions as the Chairman, and Vice-Chairman of
                Vellore Engineering College, Vellore before taking over charge
                as the Pro-Chancellor (Academic) at VIT. He has also served as
                the Secretary of the North Arcot Educational & Charitable Trust
                of Vellore.
                <br /> <br />
                He has always been a very proactive person and has played a key
                role in all the activities of the University. He has always
                evinced a keen involvement with the VIT family. He is an active
                member of the Board of Management, VIT and displays a keen
                interest in the affairs of the college and being a student
                friendly person is avidly interested in the academic progress of
                the students and staff.
                <br />
                <br />
                He has travelled extensively and gained valuable experience from
          ...
          <div className="cprof-container1">
            ...
            <div className="cprof-description">
              <p>
                Dr. Sekar Viswanathan epitomizes the vision, vibrant spirit and
                energy that has helped in establishing VIT as a premiere
                institute in the country. Dr. Sekar worked with IBM, NetClerk
                and Walmart, where he was conferred the “Best Engineering
                Manager” and “Best Achiever” awards. As VP at VIT, Dr. Sekar
                focuses on...
              </p>
            ...
            <MyModal
              ...
              keyboard={true}>
              <h5>
                <b>Dr. Sekar Viswanathan</b> Vice-President <br />
                <br />
                Dr. Sekar Viswanathan epitomises the vision, vibrant spirit and
                energy that has helped in establishing VIT as a premiere
                institute in the country. Dr. Sekar has over 30 years of
                experience in the industry and academics. He was a rank holder
                in Electronics and Communication Engineering from University of
                Madras. He received his Master’s degree in Computer Science from
                Rochester Institute of Technology, USA. He has a Ph.D., in the
                area of faculty motivation from University of Madras.
                <br /> <br />
                During the 90s, he served as the Vice-Chairman of his alma
                mater, Vellore Engineering College (which was later renamed as
                VIT). During this period, he had launched a number of new
                programmes and initiatives which paved way for the university
                status of VIT. Later, Dr. Sekar went to USA and worked with IBM,
                NetClerk and Walmart.com to gain international industrial
                experience. Walmart.com conferred the “Best Engineering Manager”
                and “Best Achiever” awards on him.
                <br /> <br />
                As VP at VIT, Dr. Sekar focuses on the university growth
                strategy, academic policies, international relations and
                placements. He has brought in numerous improvements to benefit
                the students including STARS (Support the Advancement of Rural
                Students) scheme, Fully Flexible Credit System (FFCS), Semester
                Abroad Programme (SAP) and Curriculum for Applied Learning
                (CAL). Dr. Sekar was bestowed with the prestigious Young EDGE
                National Award in 2012 in recognition of his innovative and
                useful contributions to the field of education. He currently
                serves as a member of national-level Higher Education Committee
                of FICCI (Federation of Indian Chambers of Commerce and
                Industry) and member of the Higher Education committee of EPSI
          ...
          <div className="cprof-container1">
            ...
            <div className="cprof-description">
              <p>
                ...
                first Pro-Chancellor, becoming the youngest Pro-Chancellor of a
                University...
              </p>
            ...
            <MyModal
              ...
              <h5>
                ...
                created within a short span of time under his able leadership.
                He has developed VIT Chennai campus in conformity with the
                standards of the Green LEED certification. As the Vice
                President, he continues to contribute diligently to its growth.
                ...
                into an acclaimed international event. He played a significant
                role in establishing the VIT Technology Business Incubator
                ...
                Dr G V Selvam. The centre is working towards providing urban
                ...
                Green Vellore Project, which has added green cover to the rocky
        ...
        <div className="cprof-outer">
          ...
          <div className="cprof-container2">
            <div className="cprof-basic-details">
              ...
              <div className="cprof-img-container">
                <img
                  src="images/Partha Sharathi Mallick.png"
                  alt="cprof-outer"
                />
              </div>
            ...
            <div className="cprof-description">
              <p>
                Dr. Partha Sharathi Mallick is the current Pro Vice Chancellor
                of Vellore Institute of Technology, Vellore, Tamilnadu India. He
                received the prestigious Jawaharlal Nehru Fellowship for
                doctoral studies. Dr. Mallick published 4 books/book chapters,
                132 research...
              </p>
            ...
            <MyModal
              ...
              <h5>
                ...
                received the prestigious Jawaharlal Nehru Fellowship for
                doctoral studies. Dr. Mallick published 4 books/book chapters,
                132 research papers and guided 13 PhD theses. An assessor of
                National Assessment and Accreditation Council (NAAC), Govt. of
                India, he received the VIT Chancellor’s Research Award for 10
                consecutive years and organized several conferences and summits
                around the world. He is a Sr. Member of IEEE, Life Member-Indian
                Society for Technical Education, Indian LASER Association,
                Indian Association for Cultivation of Science, Indian Physical
                Society and Ambassador (VIT) of Association of Commonwealth
                Universities.
              </h5>
            </MyModal>
          </div>
          ...
          <div className="cprof-container2">
            ...
            <div className="cprof-description">
              <p>
                Dr. (Ms.) T. Jayabarathi has been serving the Vellore Institute
                of Technology, Vellore (formerly Vellore Engineering College)
          ...
          <div className="cprof-container2">
            ...
            <div className="cprof-description">
              <p>
                ...
                circulating fluidized bed. Designed...
              </p>
          ...
          <div className="cprof-outer">
            ...
            <div className="cprof-container1">
              ...
              <div className="cprof-description">
                <p>
                  Dr. Partha Sharathi Mallick is the current Pro Vice Chancellor
                  of Vellore Institute of Technology, Vellore, Tamilnadu India.
                  He received the prestigious Jawaharlal Nehru Fellowship for
                  doctoral studies. Dr. Mallick published 4 books/book chapters,
                  132 research papers and guided 13 PhD theses. An assessor...
                </p>
            ...
            <div className="cprof-container1">
              ...
              <div className="cprof-description">
                <p>
                  Dr. (Ms.) T. Jayabarathi has been serving the Vellore
                  Institute of Technology, Vellore (formerly Vellore Engineering
                  College) almost since the inception of the institution in the
                  year 1984. Prior to becoming the Registrar, she has served the
                  institution in various capacities, including as a Head of the
                  Department...
                </p>
            ...
            <div className="cprof-container1">
              ...
              <div className="cprof-description">
                <p>
                  ...
                  from IIT Madras for his study on Hydrodynamic on Z-type radial
                  flow reactor related to hydrodynamics of Liquid-solid
                  circulating fluidized bed. Designed and fabricated 2.5 m
                  LSCFB...
                </p>
        ...
        <div className="cprof-outer">
          <div className="cprof-container1">
            ...
            <div className="cprof-description">
              <p>
                Dr. Mahesh Ganesapillai is a Professor in the School of Chemical
                Engineering at VIT, Vellore. Additionally, he serves as a
                visiting professor at the Gdansk Institute of Technology,
                Poland, National Taipei Institute of Technology, Taiwan,
                Kaohsiung National Institute of Science and Technology, Taiwan,
                and Yokohama National University, Japan...
              </p>
              ...
              <MyModal
                ...
                keyboard={true}>
                <h5>
                  Dr. Mahesh Ganesapillai is a Professor in the School of
                  Chemical Engineering at VIT, Vellore. Additionally, he serves
                  as a visiting professor at the Gdansk Institute of Technology,
                  Poland, National Taipei Institute of Technology, Taiwan,
                  Kaohsiung National Institute of Science and Technology,
                  Taiwan, and Yokohama National University, Japan. His research
                  interests focus on the closed-loop fertility cycle for
                  sustainability in sanitation and agricultural production for
          ...
          <div className="cprof-container1">
            ...
            <MyModal
              ...
              <h5>
                ...
                fields such as food processing, microwave pre-treatment, solar
          ...
          <div className="cprof-container1">
            ...
            <div className="cprof-description">
              <p>
                Dr. Thirumalini Selvaraj, Heritage Research lab, completed her
                Doctoral research in Heritage Lime mortars characterisation and
                Simulation and has 15 years of Research experience with  61
                publication in the field of heritage materials and structures.
                Her primary areas of research include developing scientific
                methods for...
              </p>
            ...
            <MyModal
              ...
              <h5>
                ...
                publication in the field of heritage materials and structures.
                Her primary areas of research include developing scientific
                methods for restoration of heritage structures, chemistry of
                Traditional building materials used in Indian heritage
                structures and development of carbon capture technology in
                buildings using organics additives, circular economy to promote
                their sustainability. She has a masters in environmental
                management and works on water and culture and published few
                ...
                charitable endowments board , state  and central Archaeological
                departments , Government of India. She has three patents to her
                credit on organic additives such as Terminalia chebula, Jaggery
                (unrefined sugar) and plant extracts from Aloe vera on lime
                mortars to replicate the traditional buildings. She is
                currently  working on  new  old materials in civil engineering,
                carbonation potential and carbon storage of  organic lime
                mortars  in bringing out the sound scientific proof for the use
                of ancient eco- friendly admixtures in  modern construction.
              </h5>
            </MyModal>
          </div>
          <div className="cprof-container1">
            ...
            <div className="cprof-description">
              <p>
                Dr. K Govardhan is a versatile researcher across various
                domains. He completed his B.E in Electrical and Electronics
                Engineering from the University of Madras, then did his M.Tech
                at VIT specialising in Sensor Systems Technology. His PhD was an
                amalgamation of Computational Fluid Dynamics, Nanotechnology &
                Sensors...
              </p>
            ...
            <MyModal
              ...
              <h5>
                ...
                at VIT specialising in Sensor Systems Technology. His PhD was an
                amalgamation of Computational Fluid Dynamics, Nanotechnology &
                Sensors. He had ingeniously developed a novel gas-sensing
                chamber for his PhD research work. He has published more than 30
                journals and high-quality conference publications. He is
                actively involved with various research project collaborations
                with Cranfield University, UK, University College London, City
                University, London, International Iberian Nanotechnology
                Laboratory, Portugal, Sri Lanka Technological Campus, etc. He
                has worked on various research projects. He has completed an
                international project with Cranfield University on Aerospace
                materials to the tune of 50 Lakhs. With a strong background in
                Sensor System Development, he has guided many of his B.Tech and
                M.Tech students in designing and developing projects based on
                sensors, with integrated data acquisition, microcontroller-based
                smart control and automation, and signal processing circuitry
                and power management circuitry for these systems. He has
                expertise in various specialised MEMS and multiphysics tools
                such as COMSOL Multiphysics, Coventorware, Intellisuite, Ansys,
                Ansoft, Elecnet, and Magnet. His research interests include
                Sensors, Nanomaterials, Nanosensors, MEMS, NEMS, FEM, CFD, Smart
                Automation, and Data Acquisition. He has organised several
                international conferences and webinars. He was also the Convener
                of graVITas’20, an International Techno-Management Carnival, the
                first-ever complete virtual technical fest organised by VIT with
                participants and industries from over 27 countries taking part
                in it. He was earlier with the Centre for Nanotechnology
                Research and currently is with the School of Electronics
                Engineering at VIT.
              </h5>
            </MyModal>
          </div>
          ...
          <div className="cprof-container1">
            ...
            <MyModal
              ...
              <h5>
                ...
                Excellence Outstanding Student Chapter Award in 2019. Nominated
                as IWA-YWP in 2019. Published more than 20 papers in National
