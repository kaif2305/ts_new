        ...
        <div className="speaker-outer">
          ...
          <div className="speaker-container">
            ...
            <MyModal
              ...
              <h5>
                ...
                and Waste to Energy, his work addresses critical environmental
                challenges and sustainability issues. Prof. Dr. Mohammed J.K.
                Bashir's contributions to academia are substantial, evident from
                his impressive publication record record of more than 250 works.
                These publications encompass a mix of journal articles and book
                chapters, demonstrating the breadth and depth of his scholarly
                contributions. Prof. Bashir is also actively involved in a
                funded research project which significantly influences
                environmental engineering practices in Malaysia and beyond,
                making a valuable contribution to the sustainable development of
                society.
              </h5>
            </MyModal>
          </div>
          ...
          <div className="speaker-container">
            ...
            <MyModal
              ...
              keyboard={true}>
              <h5>
                Jacek Czerwinski is a distinguished academician and researcher
                currently holding the position of Professor at the Lublin
                University of Technology known for his work in the field of
                Environmental Chemistry, he specializes in chromatography and
                mass spectrometry techniques, Gas Chromatography (GC),
                High-Performance Liquid Chromatography (HPLC), and Tandem Mass
                Spectrometry (MS/MS). Professor Czerwinski's primary area of
                interest revolves around studying environmental contaminants and
                their transformation products. His research also focuses on
                understanding the behaviour, fate, and impact of various
                pollutants in the environment, which are crucial for developing
                effective strategies for environmental protection and
                sustainability. His works also involve assessing water quality,
                Environmental Impact Assessment, and climate change. With a
                remarkable volume of work, Professor Czerwinski has published 45
                research papers, highlighting the depth and breadth of his
          ...
          <div className="speaker-container">
            ...
            <MyModal
              ...
              <h5>
                ...
                Philippines. She is a member of many renowned professional
                organizations such as the Integrated Chemists of the
                Philippines, Kapisanang Kimika Ng Pilipinas, Natural Products
          ...
          <div className="speaker-container">
            ...
            <MyModal
              ...
              <h5>
                ...
                the panel or responsible for assessing nearly 200 submitted
                projects, the total value of which during implementation
                exceeded PLN 1 billion. His expertise lies in various domains of
                economics, including energy, emission reduction, and sustainable
                development. Throughout his career, he has contributed
                significantly to the academic community with over 110 published
                papers in renowned journals and conference proceedings. As a
                recognized scholar in his field, he actively participates in
                scientific committees of various conferences and associations
                and also serves as a reviewer for numerous international
                journals. Maciej Dzikuć's outstanding individual scientific
                achievements have been repeatedly recognized, and he has been
                awarded several times with the prestigious scientific prize of
                the 1st degree of the Rector of the University of Zielona Góra.
              </h5>
            </MyModal>
          </div>
          ...
          <div className="speaker-container">
            ...
            <div className="speaker-description">
              <p>
                ...
                multi-scale modelling techniques and their practical
            ...
            <MyModal
              ...
              <h5>
                ...
                distinguished career, he has made significant contributions to
                multi-scale modelling techniques and their practical
                applications in various systems, including fuel cells, water
                purification, lithium-ion batteries, and membrane processes. His
                research interests help in developing advanced modelling
                techniques that integrate experiments and simulations to
                understand complex systems comprehensively. Notably, Prof.
                Hiromitsu Takaba's contributions have been recognized through
                prestigious awards such as the Outstanding Poster Paper Award
                and The Merk Award for Outstanding Scientific Contribution to
                Display Technology. With over 280 publications to his credit,
                Prof. Takaba has an extensive research portfolio, indicating his
                dedication to scholarly pursuits and knowledge dissemination.
              </h5>
            </MyModal>
          </div>
          ...
          <div className="speaker-container">
            ...
            <MyModal
              ...
              <h5>
                ...
                community, Kazuho Nakamura is associated with over 10
                prestigious organizations.Kazuho Nakamura's contributions have
